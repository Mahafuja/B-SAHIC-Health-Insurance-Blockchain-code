      ...
      <div class="vertical-menu">
         ...
         <form action="./" method="post" enctype="multipart/form-data">
            <div class="imgcontainer">
               <img src="client.ico" alt="Avatar" class="avatar">
            </div>
            <div class="container">
               <h1><label for="Name"><b>Client Name</b></label>
                  <input type="text" placeholder="Enter Client name" name="Name" required>
               </h1>

               <h1><label for="password"><b>Access Key</b></label>
                  <input type="password" placeholder="Enter Access Key" name="password" required>
               </h1>
