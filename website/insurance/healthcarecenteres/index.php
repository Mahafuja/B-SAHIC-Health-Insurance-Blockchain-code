...
//First check to see if this hospitalname is already used by another insurance company
    ...
    if ($numofrows < 1) { //hospitalname not currently in use, so create hospital account
        $sql = "INSERT INTO hospitals (Name, RegistrationDate, Address, companycell, password) VALUES ('$thiscompanyname-$hospitalname', '$registrationdate', '$address', '$companycell', '$password')";
...
<body>
   <h1>Manage Healthcare centers' claims accepted by this insurance company</h1>

   <h2 style="color:green">
      <?php echo "Logged in as: $thiscompanyname"; ?>
   </h2>
   ...
   <div class="container">
      <form action="./" method="post" enctype="multipart/form-data">
         <div class="row">
            ...
            <div class="col-75">
               <input type="text" id="hospitalname" style="width:450px" name="hospitalname"
                  value="<?php echo $hospitalname ?>" required><br><br>
            </div>
         </div>
         <div class="row">
            <div class="col-25">
...
if ($registerbuttonvalue == 'Registration Completed!') {
    echo '<input type=button onClick="window.location=\'/healthcarecenteres/\';" style="margin-right:20px" value="Reset this form"></input>' . "
...
} else if ($registerbuttonvalue == 'Hospital Registration Failed!' || $registerbuttonvalue == "Hospital Name Already in use!") {
    echo '<input type=button onClick="window.location=\'/healthcarecenteres/\';" style="margin-right:20px" value="Reset this form"></input>' . "
...
?>
   ...
   <h2>Hospital Status Panel - Only showing status of hospitals having contracts issued under this insurance company</h2>
   <div class="center">
      <?php

$query = "SELECT ID, Name, RegistrationDate, LastLogin, Address, companycell, ContractFreeze FROM  hospitals WHERE Name LIKE '$thiscompanyname%'"; //You don't need a ; like you do in SQL
